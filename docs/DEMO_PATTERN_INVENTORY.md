...
| ---------------------- | --------------------------------------------------------------------: | -------------------------------------------------------------------------------------------------------------------------------------- |
| Demo shell             |                                                         All ten demos | Keep `DemoShell` as the shared teaching frame                                                                                          |
| Stepper                |                                LLM systems, RAG, Agent, Safety / Eval | Keep the typed, unit-tested `StepperDemo`; four call sites confirm its existing step contract without requiring a wider API            |
| SVG viewport           | Search, decision boundary, Attention, LLM systems, RAG, Agent, Safety | Keep `SvgScene` as the shared fit/detail and scroll-accessibility primitive                                                            |
