...
| ---------------------- | ---------------------------------------------------------------------------------------------------------: | -------------------------------------------------------------------------------------------------------------------------------------- |
| Demo shell             |                                                                                           All twelve demos | Keep `DemoShell` as the shared teaching frame                                                                                          |
...
| SVG viewport           | Search, decision boundary, Attention, feedback learning, foundation model, LLM systems, RAG, Agent, Safety | Keep `SvgScene` as the shared fit/detail and scroll-accessibility primitive                                                            |
