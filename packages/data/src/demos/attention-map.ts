...
export const attentionMapDemo = {
  ...
  attentionModeCopy: "Attention 让每个 token 可以直接查看相关 token，远距离关系不必一格一格传递。",
  ...
  tokens: [
    ...
    },
    {
      ...
      focusDescription: "在 Attention 中，“模型”可以跨过中间词，直接连接到真正补足语义的“外部知识”。"
    },
    {
      id: "needs",
      label: "需要",
      ...
      focusDescription: "它把主体和目标连起来，说明为什么后面的检索动作会出现。"
    },
    {
      id: "knowledge",
      label: "外部知识",
      ...
      focusDescription: "这个 token 离“模型”不近，但它对句子意义最关键；Attention 可以直接把它拉近。"
    },
    {
      id: "then",
      label: "时",
    ...
    },
    {
      ...
      focusDescription: "它与“外部知识”形成强关系，解释 RAG 为什么会接在大模型之后。"
    }
  ],
  links: [
    ...
    { id: "knowledge-retrieve", from: "knowledge", to: "retrieve", weight: 0.86 },
